...
class TftDeepMomentumNetworkModel(DeepMomentumNetworkModel):
    ...
    def model_builder(self, hp):
        ...
        model.compile(loss=tf.keras.losses.BinaryCrossentropy(from_logits=False), optimizer=adam, sample_weight_mode="temporal", metrics = ["accuracy"], weighted_metrics = ["accuracy"])
